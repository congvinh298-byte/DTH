...
$contents = [
    ...
    2 => "<p>Điện Máy Hiếu hoạt động dưới mô hình \"Nền tảng TMĐT tích hợp\" và chịu trách nhiệm liên đới trong việc bảo vệ quyền lợi người tiêu dùng theo Luật Bảo vệ quyền lợi người tiêu dùng 2023 và NĐ 248/2026/NĐ-CP.</p>
    ...
    3 => "<p>Chúng tôi cam kết tính minh bạch tuyệt đối về giá cả đối với toàn bộ hàng hóa và dịch vụ trên nền tảng.</p>
        <ul>
    ...
    4 => "<p>Nhằm mang đến sự tiện lợi tối đa cho quý khách, Điện Máy Hiếu áp dụng 2 hình thức thanh toán linh hoạt, an toàn và có đầy đủ chứng từ:</p>
        <ol>
    ...
    5 => "<p>Để đảm bảo tuân thủ pháp luật và chất lượng dịch vụ, chúng tôi áp dụng các quy định sau:</p>
        <ul>
    ...
    6 => "<p>Chúng tôi luôn nỗ lực mang đến sự an tâm tuyệt đối khi khách hàng sử dụng dịch vụ và mua sắm.</p>
    ...
    7 => "<p>Điện Máy Hiếu ứng dụng công nghệ đa kênh để hỗ trợ khách hàng nhanh nhất có thể:</p>
        <ul>
...
$filename = "Toan_Bo_Ho_So_BCT.doc";
