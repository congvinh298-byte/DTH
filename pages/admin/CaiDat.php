...
$tieude = 'Cài đặt hệ thống | Điện Máy Hiếu';
...
<h2 style="margin:0 0 20px; font-size:18px; font-weight:800; color:#0f172a;"><i class="fa-solid fa-gear" style="color:#0ea5e9;"></i> Cài đặt hệ thống</h2>
    ...
    <div class="card-body">
        <form method="POST" action="">
            <div class="form-group">
                ...
                <input type="text" name="options[site_name]" class="form-control" value="<?= htmlspecialchars($options['site_name'] ?? 'Điện Máy Hiếu') ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>Nội dung footer / giới thiệu</label>
                <textarea name="options[site_footer]" class="form-control" rows="4"><?= htmlspecialchars($options['site_footer'] ?? '') ?></textarea>
            </div>
            <button type="submit" name="save_settings" class="btn btn-primary"><i class="fa-solid fa-save"></i> Lưu lại</button>
        </form>
    </div>
</div>
