...
$tieude = 'Gian hàng điện máy | Điện Máy Hiếu';
...
<h2 style="margin:0 0 20px; font-size:18px; font-weight:800; color:#0f172a;"><i class="fa-solid fa-plug" style="color:#0ea5e9;"></i> Gian hàng Điện máy</h2>
...
<div class="card" style="margin-bottom:24px;">
    <div class="card-header">
        <h3><i class="fa-solid <?= $editProduct ? 'fa-pen' : 'fa-plus' ?>"></i> <?= $editProduct ? 'Sửa sản phẩm' : 'Thêm sản phẩm mới' ?></h3>
        ...
        <form method="POST" action="/controller/admin/SaveProduct.php" enctype="multipart/form-data">
            ...
            <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap:16px;">
                ...
                <div class="form-group" style="grid-column: 1 / -1;">
                    ...
                    <textarea name="description" class="form-control" rows="4" placeholder="Nhập mô tả chi tiết sản phẩm..."><?= $editProduct ? htmlspecialchars($editProduct['description'] ?? '') : '' ?></textarea>
                </div>
            </div>
...
<div class="card">
    <div class="card-header">
        <h3>Danh sách sản phẩm Điện máy</h3>
...
<div class="card">
    <div class="card-header">
        <h3>Danh mục Gian hàng Điện máy</h3>
...
function deleteCat(id) {
    ...
    fetch('/controller/admin/DeleteCategory.php?id=' + id + '&type=dienmay')
        .then(r => r.json())
        .then(res => {
            if (res.status === 'success') location.reload();
            else alert(res.msg || 'Lỗi kết nối');
