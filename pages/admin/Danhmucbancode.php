...
if(isset($_GET['xoa']) && $getUser['level'] == 'admin')
{
    ...
    if(!$user2) {
        ...
        if($dele) {
            ...
            echo msg_admin("error","Xóa thất bại. Lỗi hệ thống", BASE_URL('Admin/Danhmucbancode'), 2000); die;
        }
    }
}
?>
<h2>Danh mục bán code</h2>
<div class="row">
    <div class="col-md-12">
...
<table class="table table-bordered responsive">
	...
	<tbody>
        ...
        <tr>
            ...
            <td>
                <a href="<?=BASE_URL('pages/admin/EditDanhmucbancode.php?id='.$row['id'].'');?>" class="btn btn-default btn-sm btn-icon icon-left">
					<i class="entypo-pencil"></i>
					Edit
				</a>
				<a href="<?=BASE_URL('Admin/Danhmucbancode?xoa='.$row['id'].'');?>" class="btn btn-danger btn-sm btn-icon icon-left">
