...
$tieude = 'EDIT DANH MỤC TẠO WEBSITE';
...
if(isset($_GET['id']) && $getUser['level'] == 'admin') {
    ...
    $row = $TUANORI->get_row(" SELECT * FROM `danhmuctaoweb` WHERE `id` = '".$_GET['id']."'");
    if(!$row)
    {
        echo msg_admin("error","Danh mục không tồn tại",BASE_URL('Admin/Danhmuctaoweb'), 1000); die;
    }
} else {
    echo msg_admin("error","Đường link không hợp lệ",BASE_URL('Admin/Danhmuctaoweb'), 1000); die;
}
?>
<h2>EDIT Danh mục tạo web <a href="/Admin/Danhmuctaoweb" class="btn btn-info"><i class="fa fa-backward"></i> Quay Lại</a></h2>
<div class="row">
            ...
            <div class="panel-body">
                <form role="form" class="form-horizontal form-groups-bordered">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="url" id="img" value="<?=$row['img'];?>" class="form-control daterange" />
                        </div>
                    </div>
                    <div class="form-group">
