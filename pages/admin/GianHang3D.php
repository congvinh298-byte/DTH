...
$tieude = 'Gian hang 3D | Dien May Hieu';
...
<h2 style="margin:0 0 20px; font-size:18px; font-weight:800; color:#0f172a;"><i class="fa-solid fa-cube" style="color:#0ea5e9;"></i> Gian hang 3D</h2>
    ...
    <div class="modal-box">
        ...
        <form id="catForm" method="POST" action="/controller/admin/SaveCategory.php">
            ...
            <div class="form-group">
                ...
                <input type="text" name="slug" id="catSlug" class="form-control" placeholder="mo-hinh-3d...">
            </div>
            <div class="form-group">
                <label>Thu tu</label>
...
function deleteCat(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch('/controller/admin/DeleteCategory.php?id=' + id + '&type=3d', { method: 'GET' })
            .then(r => r.json())
            .then(res => {
