                                                    ...
                                                    <div class="p-2">
                                                        ...
                                                        <div class="text-center grid grid-cols-2 gap-3">
                                                            <div class="col-span-2">
                                                                <div class="border border-red-500 rounded-lg p-1 font-bold">Hiện có <span class="text-green-600"><?=number_format($DMH->num_rows(" SELECT * FROM `danhsachmuacode` WHERE `id_danhmuc` = '".$row['id']."'"));?></span> mã nguồn</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-span-2">
                                                                <a href="/danh-muc-code/<?=$row['id'];?>">
