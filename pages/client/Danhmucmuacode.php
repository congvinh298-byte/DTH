            ...
            <main id="content_layout">
                ...
                <section>
                    <div class="text-center mb-5">
                        <h1 class="text-[20px] md:text-[30px] mb-1">Danh mục sản phẩm</h1>
                                        ...
                                        <div class="ant-ribbon-wrapper css-eq3tly">
                                            <div class="ant-ribbon-wrapper css-eq3tly">
                                                <div class="border border-primary rounded-lg p-[1px]" style="background: transparent;">
                                                    ...
                                                    <img alt="<?=$row['title'];?>" src="/images/svg/spinner.svg" data-src="<?=$row['img'];?>" class="lazyload w-full lg:h-[180px] rounded-t-lg object-fill">
                                                        <a href="/danh-muc-code/<?=$row['id'];?>">
                                                    ...
                                                    <div class="p-2">
                                                        ...
                                                        <div class="text-center w-full">
                                                            <a href="/danh-muc-code/<?=$row['id'];?>"><h2 class="text-xl md:text-1xl mb-1"><?=$row['title'];?></h2></a>
                                                        </div>
                                                        ...
                                                        <div class="text-center grid grid-cols-2 gap-3">
                                                            <div class="col-span-2">
                                                                <div class="border border-red-500 rounded-lg p-1 font-bold">Hiện có <span class="text-green-600"><?=number_format($TUANORI->num_rows(" SELECT * FROM `danhsachmuacode` WHERE `id_danhmuc` = '".$row['id']."'"));?></span> mã nguồn</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-span-2">
                                                                <a href="/danh-muc-code/<?=$row['id'];?>">
                                                                    <button class="btn btn-sm btn-primary w-full"><i class="fas fa-eye me-2"></i><span>Xem các mẫu</span>
                                                                    </button>
                                                                </a>
                                                            </div>
                                                            <!---->
