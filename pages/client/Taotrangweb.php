...
$tt = $TUANORI->get_row(" SELECT * FROM `danhsachtaoweb` WHERE `id` = '$id' AND `hienthi` = 'SHOW'");
...
if($TUANORI->site('sukien') == 'ON') {
    $tongtien = $tt['money'] - ($tt['money'] * $TUANORI->site('ptgiamgia') / 100);
}
else {
    $tongtien = $tt['money'];
}
                            ...
                            <div class="card">
                                <div class="card-body grid grid-cols-1 gap-x-6 p-6 md:grid-cols-6">
                                    <div class="ant-ribbon-wrapper css-eq3tly">
                                        ...
                                        <?php if($TUANORI->site('sukien') == 'ON' && $TUANORI->site('ptgiamgiaweb') > 0) { ?>
                                  ...
                                  <form method="POST" class="space-y-3">
                                      ...
                                      <div class="text-center">
                                        <h2 class="text-sm text-primary">Giá: 
                                            <?php if($TUANORI->site('sukien') == 'ON' && $TUANORI->site('ptgiamgiaweb') > 0 && $tt['money'] > 0) { ?> 
                                                <del><b style="color: red"><?=sotienmua($tt['money']);?></b></del> - <b style="color: green"><?=sotienmua($tt['money'] - $tt['money']*$TUANORI->site('ptgiamgiaweb')/100);?></b>
                                            <?php } else { ?>
