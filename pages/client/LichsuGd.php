                ...
                <section id="app" class="space-y-6" data-v-app="">
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4">
                        <div class="relative flex items-center rounded-[6px] bg-cover bg-center bg-no-repeat px-5 py-8" style="background-image: url(&quot;https://lychuotbach.vn/images/all-img/widget-bg-1.png&quot;);">
                            <div class="flex-1">
                                <div class="max-w-[180px]">
                                    <h4 class="mb-2 text-2xl font-medium text-[#27374D]"><span class="block text-sm">Số Tiền Hiện Có,</span><span class="block"><?=number_format($getUser['money']);?> ₫</span></h4>
                                </div>
                            </div>
                        ...
                        <div class="relative flex items-center rounded-[6px] bg-cover bg-center bg-no-repeat px-5 py-8" style="background-image: url(&quot;https://lychuotbach.vn/images/all-img/widget-bg-2.png&quot;);">
                            <div class="flex-1">
                                <div class="max-w-[180px]">
                                    <h4 class="mb-2 text-2xl font-medium text-white"><span class="block text-sm"> Số Tiền Đã Nạp, </span><span class="block"><?=number_format($getUser['total_money']);?> ₫</span></h4>
                                </div>
                            </div>
                            <div class="flex-none"><a href="/Nap-Tien" class="btn-light btn-sm btn bg-white">NẠP THÊM</a>
                            </div>
                        ...
                        <div class="relative flex items-center rounded-[6px] bg-cover bg-center bg-no-repeat px-5 py-8" style="background-image: url(&quot;https://lychuotbach.vn/images/all-img/widget-bg-3.png&quot;);">
                            <div class="flex-1">
                                <div class="max-w-[180px]">
                                    <h4 class="mb-2 text-2xl font-medium text-white"><span class="block text-sm"> Số Tiền Đã Tiêu, </span><span class="block"><?=number_format($getUser['total_money'] - $getUser['money']);?> ₫</span></h4>
                                </div>
                            </div>
                            <div class="flex-none"><a href="/Nap-Tien" class="btn-light btn-sm btn bg-white">NẠP THÊM</a>
                            </div>
                                                        ...
                                                        <table style="table-layout: auto;">
                                                            ...
                                                            <thead class="ant-table-thead">
                                                                <tr>
                                                                    ...
                                                                    <th class="ant-table-cell" colstart="2" colend="2">Số dư trước</th>
                                                                    <th class="ant-table-cell" colstart="3" colend="3">Số tiền</th>
                                                                    <th class="ant-table-cell" colstart="4" colend="4">Số dư sau </th>
                                                                    <th class="ant-table-cell" colstart="5" colend="5">Nội dung</th>
                                                                    <th class="ant-table-cell" colstart="6" colend="6">Thời gian</th>
                                                                ...
                                                                <?php $i = 0; foreach($DMH->get_list(" SELECT * FROM `biendongsodu` WHERE `username` = '".$getUser['username']."' ORDER BY id DESC LIMIT 30") as $row){ ?>
                                                                    <tr class="ant-table-row ant-table-row-level-0">
                                                                        ...
                                                                        <?php if($row['sau'] >= $row['truoc']) { ?>
                                                                            <td class="ant-table-cell text-green-500">+ <?=number_format($row['tongtien']);?> ₫</td>
                                                                        <?php } else { ?>
                                                                            <td class="ant-table-cell text-red-500">- <?=number_format($row['tongtien']);?> ₫</td>
                                                                        <?php } ?>
                                                                        <td class="ant-table-cell"><?=number_format($row['sau']);?> ₫</td>
                                                                        <td class="ant-table-cell"><?=$row['note'];?></td>
