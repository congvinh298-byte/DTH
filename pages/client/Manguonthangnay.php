            ...
            <main id="content_layout">
                ...
                <section>
                    <div class="text-center mb-5">
                        <h1 class="text-[20px] md:text-[30px] mb-1">Sản phẩm mới được đăng trong tháng <?=date('m', time());?></h1>
                    ...
                    <div id="app" data-v-app="">
                        <section>
                            ...
                            <div class="ant-row css-eq3tly" style="margin-left: -9px; margin-right: -9px;">
                                <?php foreach($DMH->get_list(" SELECT * FROM `danhsachmuacode` WHERE YEAR(ngaydang) = ".date('Y')." AND MONTH(ngaydang) = ".date('m')." ORDER BY id DESC") as $row){ ?>
