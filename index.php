    ...
    <section class="section panel booking-shell" id="goi-tho">
        ...
        <form id="bookingForm">
            ...
            <div class="form">
                ...
                <div class="field full">
                    <label for="issue_description">Mô tả chi tiết sự cố / Yêu cầu in 3D *</label>
                    <textarea id="issue_description" name="issue_description" required maxlength="2000" placeholder="VD: Máy lạnh không mát, hoặc in chi tiết nhựa ABS dài 10cm..."></textarea>
                </div>
            </div>
